...
{% include image.html url="" caption="Les vignes, la vendangeuse et son travail à gauche; les 2 boules blanches de Spy Valley au centre; les pivoines avant et après la taille à droite" %}
...
{% include image.html url="" caption="Chez Rosemary et Jeremy : le jardin, la maison et Archie" %}
...
{% include image.html url="" caption="La terrasse des wwoofers, la piscine, Blenheim et ses environs" %}
