...
excerpt: "Or why the hell did this article is published so late...
...
<h4><a href="https://goo.gl/photos/KL3DrfFLf9iKn6Js8">Album Photo</a></h4>
...
<p>
  <a href="JavaScript:showAllIcons()">Show all icons,</a>
...
function setPost(code) {
  $('#post').load('/samoa/2015/08/' + code + '-en/', function() {
...
function initialize() {
  ...
  $('#post').load('/samoa/2015/08/story-en/');
